  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <Helmet>
            <title>Leagues | BocoScan</title>
            <meta
              name="description"
              content="Here is a list of Boco Leagues"
            />
          </Helmet>
          <Row>
            <Col lg={12} xs={12}>
        ...
        >
          ...
          <SideNav.Nav selected={selected} defaultSelected="leagues">
            ...
            <NavItem eventKey="movement" onClick={ e => this.props.history.push("/movement") } title="Movement">
                        <NavIcon>
                            <i className="fa fa-fw fa-arrow-right" style={{ fontSize: '1.5em', color: 'black' }} />
                        </NavIcon>
                        <NavText>
            ...
            <NavItem eventKey="fundingcycles" onClick={e => this.props.history.push("/fundingcycles")}
