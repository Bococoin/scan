...
export default class BlocksTable extends Component {
    ...
    render(){
        ...
        <div>
            ...
            <Helmet>
                <title>Latest Blocks | BocoScan</title>
                <meta name="description" content="Latest blocks committed by validators on BocoScan" />
            </Helmet>
            {/* <Row> */}
            ...
            <SideNavigation selected="blocks" onToggle={this.onToggle} history={this.props.history}></SideNavigation>
            </div>
            )
    }
}
