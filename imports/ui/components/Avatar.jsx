...
export default class Avatar extends React.Component {
    ...
    render() {
        return (
            <img width={24} height={24} src={this.state.avatar} alt={this.props.moniker} className={this.props.list?'moniker-avatar-list img-fluid rounded-circle':'img-fluid rounded-circle'} />
        );
    }
}