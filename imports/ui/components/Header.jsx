...
export default class Header extends Component {
  ...
  render() {
      return (
          ...
          <Navbar dark expand="lg" fixed="top" id="header">
              <NavLink className="navbar-brand" to="/"><img src="/img/main-logo-1024.png" className="img-fluid logo"/></NavLink>
              ...
              {/*<a class="btn d-none d-lg-inline-block  mb-3 mb-md-0 ml-md-3 text-light border border-primary" href="https://wallet.test.bococoin.com">Wallet</a>*/}
              ...
              <Collapse isOpen={this.state.isOpen} navbar>
                  <Nav className="ml-auto text-nowrap" navbar>
                      ...
                      <NavItem onClick={() => {
                          ...
                          <NavLink className={window.location.pathname.split('/')[1]==="top" ?'iss-active':null} to="/top"><T>navbar.top</T></NavLink>
                      </NavItem>
                      <NavItem onClick={() => {
                              this.toggleClose();
                            }} id="toggle" className="toggle">
