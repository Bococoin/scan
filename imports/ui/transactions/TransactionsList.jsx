...
export default class Transactions extends Component{
    constructor(props){
        ...
        this.location = location.pathname.includes('/transactions')
            ? 'transactions'
            : 'dashboard';
        ...
        this.state = {
            ...
            priority: 2,
            loadmore: false,
            customHeader: location.pathname.includes('/transactions') ? 'transactions.latestTransactions' : false,
    ...
    componentDidUpdate(prevProps){
        if (this?.props?.location && this.props.location?.pathname != prevProps.location?.pathname) {
            this.setState({
                sidebarOpen: this.props.location.pathname.includes('/transactions') && (this.props.location.pathname.split("/transactions/").length == 2)
            })
        }
    }
    ...
    render(){
        ...
        <div id="transactions" style={{
            ...
            <Helmet>
                <title>Latest Transactions | BocoScan</title>
            ...
            <List limit={this.state.limit} customHeader={this.state.customHeader} />
            <LoadMore show={this.state.loadmore} />
            </div>
            {this.location === 'transactions' && <SideNavigation selected={this.location} onToggle={this.onToggle} history={this.props.history}></SideNavigation>}
            </div>
            )
    }
}
