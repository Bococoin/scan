            ...
            <CardBody>
                <Nav tabs className="tx-types">
                    <NavItem>
                        ...
                        >
                            <T>transactions.transfer</T> ({numbro(this.state.transferTxs.length).format(window.config.numbers.decimalFormat)})
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink
                        ...
                        >
                            <T>transactions.staking</T> ({numbro(this.state.stakingTxs.length).format(window.config.numbers.decimalFormat)})
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink
                        ...
                        >
                            <T>transactions.distribution</T> ({numbro(this.state.distributionTxs.length).format(window.config.numbers.decimalFormat)})
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink
                        ...
                        >
                            <T>transactions.governance</T> ({numbro(this.state.governanceTxs.length).format(window.config.numbers.decimalFormat)})
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink
                        ...
                        >
                            <T>transactions.slashing</T> ({numbro(this.state.slashingTxs.length).format(window.config.numbers.decimalFormat)})
                        </NavLink>
                    </NavItem>
                </Nav>
