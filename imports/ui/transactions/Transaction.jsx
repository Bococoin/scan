        ...
        if (this.props.loading){
            ...
            if (this.props.transactionExist){
                ...
                return <Container id="transaction" className="paddingleft">
                    <Helmet>
                        <title>Transaction {tx.txhash} | BocoScan</title>
                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col md={8} className="value"><Link to={"/blocks/"+tx.height}>{numbro(tx.height).format(window.config.numbers.decimalFormat)}</Link> ({moment.utc(tx.block().time).format(window.config.dateTimeFormat.default)})</Col>
                                ...
                                <Col md={8} className="value">{numbro(tx.gas_used).format(window.config.numbers.decimalFormat)} / {numbro(tx.gas_wanted).format(window.config.numbers.decimalFormat)}</Col>
