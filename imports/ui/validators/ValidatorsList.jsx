...
export default class Validators extends Component{
    ...
    render() {
        ...
        <div>
            ...
            <Helmet>
                <title>Validators | BocoScan</title>
                <meta name="description" content="Here is a list of Boco Validators" />
            </Helmet>
            {/* <Row> */}
                {/* <Col lg={12} xs={12}><h1 className="d-none d-lg-block">{title}</h1></Col> */}
                {/* <Col lg={9} xs={12} className="text-lg-right"><ChainStates /></Col> */}
            {/* </Row> */}
            <Nav pills className="status-switch mb-4">
                <NavItem>
            ...
            <Row className="validator-list">
                {this.props.match.url == "/validators" && <div class="col-12 table-name"><T>validators.listOfActive</T></div>}    
                {this.props.match.url.indexOf("inactive")>0 && <div class="col-12 table-name"><T>validators.listOfInactive</T></div>}  
                <Col md={12}>
                    <Card body>
                        <Row className="header">
                            <Col className="d-none d-md-block counter" md={1}>&nbsp;</Col>
                            <Col className="moniker" md={2} onClick={(e) => this.toggleDir('moniker',e)}>{/*<i className="material-icons">perm_contact_calendar</i>*/} <span className="d-inline-block d-md-none d-lg-inline-block"><T>validators.moniker</T></span> {renderToggleIcon(this.state.monikerDir)}
                           </Col>
