        ...
        if (this.props.loading){
            ...
            if (this.props.validatorExist){
                ...
                return <Row className="validator-details">
                    <Helmet>
                        <title>Node { moniker } | BocoScan</title>
                        ...
                        <Card>
                            ...
                            <CardBody className="voting-power-card">
                                <Row>
                                    ...
                                    <Col sm={6} className="value">{this.props.validator.self_delegation?<span>{numbro(this.props.validator.self_delegation).format(window.config.numbers.selfDelegations)} <small className="text-secondary">(~{numbro(this.props.validator.voting_power*this.props.validator.self_delegation).format({thousandSeparated: window.config.thousandSeparated,mantissa:0})} {Meteor.settings.public.stakingDenom})</small></span>:'N/A'}</Col>
                                    ...
                                    {(this.props.validator.jailed)?<Col xs={12} >
                                        <Row><Col md={6} className="label"><T>validators.unbondingHeight</T></Col>
                                            ...
                                            <Col md={6} className="value">{ moment.utc(this.props.validator.unbonding_time).format(window.config.dateTimeFormat.default)}</Col>
                                        </Row></Col>:''}
                                </Row>
                            </CardBody>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardBody>
                                <Row className="marginright">
                                    ...
                                    <Col sm={8} className="value">{this.props.validator.commission?numbro(this.props.validator.commission.commission_rates.rate*100).format('0.00')+"%":''} <small className="text-secondary">({this.state.updateTime})</small></Col>
                                    <Col sm={4} className="label"><T>validators.maxRate</T></Col>
                                    <Col sm={8} className="value">{this.props.validator.commission?numbro(this.props.validator.commission.commission_rates.max_rate*100).format('0.00')+"%":''}</Col>
                                    <Col sm={4} className="label"><T>validators.maxChangeRate</T></Col>
                                    <Col sm={8} className="value">{this.props.validator.commission?numbro(this.props.validator.commission.commission_rates.max_change_rate*100).format('0.00')+"%":''}</Col>
                                </Row>
                            </CardBody>
                        </Card>
