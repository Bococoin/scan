                ...
                this.setState({
                    ...
                    delegations: delegations.map((d, i) => {
                        return <Row key={i} className="delegation-info">
                            ...
                            <Col md={4}>{numbro(d.shares/this.props.shares*this.props.tokens/Meteor.settings.public.stakingFraction).format(window.config.numbers.decimalFormatWithSeparator)} {Meteor.settings.public.stakingDenom}</Col>
                        </Row>
                    })
                })
            }
