    ...
    render() {
        if (this.props.loading){
            ...
            if (this.props.validatorExist){
                return <div>
                    <Helmet>
                        <title>Missed Blocks by { this.props.validator.description.moniker } | BocoScan</title>
                    ...
                    {this.props.statusExist?<div><em><T>validators.lastSyncTime</T>: {moment.utc(this.props.status.lastMissedBlockTime).format(window.config.dateTimeFormat.default)}</em></div>:''}
                </div>
            }
