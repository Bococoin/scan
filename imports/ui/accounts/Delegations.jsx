                    ...
                    this.setState({
                        ...
                        delegations: delegations.map((d, i) => {
                            return <Row key={i} className="delegation-info">
                                ...
                                <Col xs={6} md={4}>{numbro(d.shares/Meteor.settings.public.stakingFraction).format(window.config.numbers.decimalFormat)} {Meteor.settings.public.stakingDenom}</Col>
                            </Row>
                        })
                    })
                }
